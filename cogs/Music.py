...
class Music(commands.Cog, wavelink.WavelinkMixin):
    ...
    @commands.command(name="connect", aliases=["join"], brief=" +connect")
    ...
    @commands.command(name="disconnect", aliases=["leave"], brief=" +disconnect")
    ...
    @commands.command(name="play", brief=" +play")
    ...
    @commands.command(name="pause", brief=" +pause")
    ...
    @commands.command(name="stop", brief="+stop")
    ...
    @commands.command(name="next", aliases=["skip"], brief=" +next")
    ...
    @commands.command(name="previous", brief=" +previous")
    ...
    @commands.command(name="repeat", brief="+repeat")
    ...
    @commands.command(name="queue", brief=" +queue")
    ...
    @commands.group(name="volume", brief=" +volume", invoke_without_command=True)
    ...
    @volume_group.command(name="up", brief=" +up")
    ...
    @volume_group.command(name="down", brief=" +down")
    ...
    @commands.command(name="lyrics", brief="= +lyrics")
    ...
    @commands.command(name="eq", brief=" +eq")
    async def eq_command(self, ctx, preset: str):
        """ `+eq flat | boost | metal | piano` """
        player = self.get_player(ctx)
    ...
    @commands.command(name="adveq", aliases=["aeq"], brief=" +adveq")
    ...
    @commands.command(name="playing", aliases=["np"], brief=" +playing")
    async def playing_command(self, ctx):
        """ `+playing <shows the current playing songs>` """
        player = self.get_player(ctx)
    ...
    @commands.command(name="skipto", aliases=["playindex"], brief=" +skipto")
    ...
    @commands.command(name="restart", brief="+restart")
    async def restart_command(self, ctx):
        """ `+restart <resets queue>` """
        player = self.get_player(ctx)
    ...
    @commands.command(name="seek", brief=" +seek")
    async def seek_command(self, ctx, position: str):
        """ +seek <mention in seconds` """
        player = self.get_player(ctx)
